...
//takes a point on the plane, the normal of the plane, and the line being
...
//System.out.println(line);
        double d = normal.x*point.getX()+normal.y*point.getY()
                +normal.z*point.getZ();// the d in ax+by+cz=d
